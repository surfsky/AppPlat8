...
module.exports = async (browser) => {
    ...
    const pages = [
        ...
        { url: '/Checks/CheckObjectForm?id=0', name: '检查对象表单' },
        { url: '/Checks/CheckSheets', name: '检查表' },
        { url: '/Checks/CheckSheetForm?id=0', name: '检查表表单' },
        { url: '/Checks/CheckTasks', name: '检查任务' },
        { url: '/Checks/CheckLogs', name: '检查记录' },
        { url: '/Checks/CheckHazards', name: '隐患管理' }
    ];
