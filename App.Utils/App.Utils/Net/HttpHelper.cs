...
namespace App.Utils
{
    ...
    public static class HttpHelper
    {
        ...
        public static SKBitmap ToImage(this HttpWebResponse response)
        {
        ...
        public static SKBitmap GetThumbnail(string url, int w, int? h = null)
        {
            //Image img = HttpHelper.GetServerOrNetworkImage(url);
            SKBitmap img = GetNetworkImage(url);
            if (img == null) return null;
            var result = Painter.Thumbnail(img, w, h);
            img.Dispose();
            return result;
        }
        ...
        public static SKBitmap GetNetworkImage(string url)
        {
            try
            {
