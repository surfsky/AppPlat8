...
namespace App.Utils
{
    ...
    public static partial class IO
    {
        ...
        public static string CombinePath(this string path1, string path2)
        {
            ...
            path1 = path1.Replace('/', sep).Replace('\\', sep).TrimEnd(sep);
            path2 = path2.Replace('/', sep).Replace('\\', sep).TrimStart(sep);
        ...
        public static string ToRelativePath(this string physicalPath, string root)
        {
            ...
            {
                var p = Path.DirectorySeparatorChar + physicalPath.Substring(root.Length);
                return p;
            }
            return "";
        }
        ...
        public static bool IsImageFile(this string fileName)
        {
            ...
            string[] exts = new string[] { ".jpg", ".png", ".gif", ".jpeg", ".bmp", ".tif", ".tiff", ".webp" };
        ...
        /// 参考 IISExpress application.config
        /// </summary>
