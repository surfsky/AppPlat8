...
namespace App.HttpApi
{
    ...
    public partial class HttpApiHelper
    {
            ...
            )
        {
            ...
            {
                result = new APIResult(0, wrapInfo, result, null);
        ...
        public static void WriteError(HttpContext context, int errorCode, string info)
        {
            ...
            {
                var result = new APIResult(errorCode, info);
        ...
        static ResponseType ParseDataType(Type t)
        {
            ...
            if (IsType(t, typeof(SKBitmap)))              return ResponseType.Image;
            if (IsType(t, typeof(SKImage)))               return ResponseType.Image;
