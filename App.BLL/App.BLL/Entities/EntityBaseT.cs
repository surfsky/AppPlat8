...
namespace App.Entities
{
        ...
        where T : EntityBase, new()
    {
        ...
        public static string AllCacheName => string.Format("{0}-All", typeof(T).Name);
        public static string TreeCacheName => string.Format("{0}-Tree", typeof(T).Name);
        ...
        */
        ...
        public static T GetDetail(Expression<Func<T, bool>> condition)
        {
            return IncludeSet.Where(condition).FirstOrDefault();
        }
